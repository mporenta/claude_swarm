...
class AirflowAgentSession:
    ...
    async def start(self):
        ...
        print(
            "  1. 🆕 Start a new Apache Airflow DAG project with Product Manager guidance"
        )
...
"""
        ...
        display_message(
            "[bold cyan]🚀 Starting Airflow DAG migration orchestrator...[/bold cyan]\n"
        )
...
if __name__ == "__main__":
    ...
    # Output directory: /home/dev/claude_swarm/generated_dags
    output_dir = (
        script_path.parent / "generated_dags"
    )  # /home/dev/claude_swarm/generated_dags /Users/mike.porenta/python_dev/aptive_github/data-airflow/dags

    # Ensure the generated_dags directory exists
    ...
    display_message(
        "[bold magenta]║  Airflow DAG Development Agent (Multi-Agent)     ║[/bold magenta]"
    )
    display_message(
        "[bold magenta]╚═══════════════════════════════════════════════════╝[/bold magenta]\n"
    )
    ...
    options_config_path = script_path.parent.parent / "airflow_agent_options.yaml"
    options_context = {
